...
describe.only('Custom Tests', function () {
  ...
  it('[assignment] iii. see assignment doc for details', async () => {
    ...
    const bobEthAddress = '0x0000000000000000000000000000000000000069'
    ...
    const aliceRecipient = '0x0000000000000000000000000000000000000420'
    await transaction({
      tornadoPool,
    ...
    const aliceBalance = await token.balanceOf(aliceRecipient)
